...
public class Solver implements Runnable {
    ...
    class SortImplicant_1 implements Comparator<Implicant> {
        public int compare(Implicant r1, Implicant r2) {
    ...
    class SortImplicant_2 implements Comparator<Implicant> {
        public int compare(Implicant r1, Implicant r2) {
//          System.out.println("Comp " + r1 + " with " + r2);
    ...
    class SortImplicant_3 implements Comparator<Implicant> {
        public int compare(Implicant r1, Implicant r2) {
    ...
    public void Solve() {
        ...
        for (int f = 0; f < number_of_out_var; f++) {
            ...
            Arrays.sort(lstPrimes, 0, ctdc1, new SortImplicant_1());
...
*/
                                    d = Arrays.binarySearch(lstPrimes, newstart, ctdc1, np, new SortImplicant_2());
//                                    System.out.print("trying " + tempj + " with " + lstPrimes[k] + " " + d);
                                    if(d < 0) { // new prime implicant found
                                        ...
                                        Arrays.sort(lstPrimes, newstart, ctdc1, new SortImplicant_2());
    ...
    public void Format(){
        ...
        for (int f = 0; f < number_of_out_var; f++) {
            ...
            if (sum_of_products_not_product_of_sums) {
                ...
                Collections.sort(epi, new SortImplicant_3());
            }
            ...
            for (int i = 0; i < mx; i++) {
                ...
                if (primeI != null) {
                    if (sum_of_products_not_product_of_sums) {
                        ...
                        Collections.sort(primeI.get(i), new SortImplicant_3());
                    }
